document.addEventListener("DOMContentLoaded", () => {
    ...
    function popUp() {
        ...
        const verificationUrl = document.getElementById('verify-route')?.dataset?.registerRoute;
        ...
        if (firstForm && secondForm && imageContainer && formContainer) {
            ...
            applyButton.addEventListener("click", () => {
                if (!applyButton.disabled) {
                    ...
                    const route = document.getElementById('register-route').dataset.registerRoute;
                    fetch(route, {
                        method: "POST",
                        headers: {
