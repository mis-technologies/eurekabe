            ...
            <div class="lg:col-span-3">
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title">All Advocates</h6>
                    </div>
            ...
            <div class="col-span-3">
                <div class="card">
                    <div class="card-header flex justify-between">
                        <h6 class="card-title">Advocates</h6>
                                ...
                                <div class="overflow-hidden">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                            @foreach ($advocates as $s)
                                                <tr>
                                                    <td
                                                        class="px-6 py-4 whitespace-nowrap text-sm text-gray-200 dark:text-gray-200">
                                                        {{ $loop->index +1 }}</td>
                                                    <td
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                        ...
                                                        <form action="{{  route('admin.update.user.status', $s?->id )}}" onclick="return confirm('Are you sure you want to Toggle User status?')" method="POST">
                                                            @csrf

                                                            <button class="text-primary hover:text-sky-700">Approve/Disapprove</button>
                                                        </form>
