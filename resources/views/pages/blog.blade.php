 ...
 <div id="tech" class="content container">
   <div class="flex flex-wrap justify-center lg:justify-between gap-auto items-center  md:items-start">
     ...
     <div class="col-lg-3 m-5 p-5">
       <div class="card w-full max-w-[350px] space-y-4 text-[15px]">
         <div class="image-container w-full h-[240px]">
           <img src="./images/programs/man.png" alt="" class="w-full h-full object-cover" />
         </div>
         <div class="cardContent space-y-3">
           <h4 class="font-bold">The revolution Ai Chatbot Training library for NodeJS</h4>
           <p class="opacity-50 text-[13px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum tempore, numquam unde natus quidem tenetur aliquam cum dolore ex iste.</p>
           <h6 class="font-bold text-[11px]">22 February, 2025</h6>
           <a href="./article.html" class="bg-primary rounded-[5px] p-2 font-bold text-white text-[12px] inline-flex items-center justify-between gap-x-2 hover:bg-opacity-85 readArticle">
             <span>Read article </span>
             <span class="border-2 border-white rounded-full inline-flex items-center w-4 h-4"><i class="fa-solid fa-arrow-right text-[9px]"></i></span>
           </a>
         </div>
       </div>
     </div>
     ...
     <div class="col-lg-3 m-5 p-5">
       <div class="card w-full max-w-[350px] space-y-4 text-[15px]">
         <div class="image-container w-full h-[240px]">
           <img src="./images/programs/ladies.png" alt="" class="w-full h-full object-cover" />
         </div>
         <div class="cardContent space-y-3">
 ...
 <div id="politics" class="content container">
   <div class="flex flex-wrap justify-between gap-auto items-center  md:items-start">
     ...
     <div class="col-lg-3 m-5 p-5">
       <div class="card w-full max-w-[350px] space-y-4 text-[15px]">
         <div class="image-container w-full h-[240px]">
           <img src="./images/programs/politics.jpg" alt="" class="w-full h-full object-cover" />
         </div>
         <div class="cardContent space-y-3">
           <h4 class="font-bold">Marketing</h4>
           <p class="opacity-50 text-[13px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum tempore, numquam unde natus quidem tenetur aliquam cum dolore ex iste.</p>
     ...
     <div class="col-lg-3 m-5 p-5">
       <div class="card w-full max-w-[350px] space-y-4 text-[15px]">
         <div class="image-container w-full h-[240px]">
           <img src="./images/programs/flag-nigeria.jpg" alt="" class="w-full h-full object-cover" />
         </div>
         <div class="cardContent space-y-3">
           <h4 class="font-bold">MarketTall women have longer life span compared to short women</h4>
           <p class="opacity-50 text-[13px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum tempore, numquam unde natus quidem tenetur aliquam cum dolore ex iste.</p>
 ...
 <div id="entertainment" class="content container">
   <div class="flex flex-wrap justify-between gap-auto items-center  md:items-start">
     ...
     <div class="col-lg-3 m-5 p-5">
       <div class="card w-full max-w-[350px] space-y-4 text-[15px]">
         <div class="image-container w-full h-[240px]">
           <img src="./images/programs/entertainment.jpg" alt="" class="w-full h-full object-cover" />
         </div>
         <div class="cardContent space-y-3">
           <h4 class="font-bold">Marketing</h4>
           <p class="opacity-50 text-[13px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum tempore, numquam unde natus quidem tenetur aliquam cum dolore ex iste.</p>
     ...
     <div class="col-lg-3 m-5 p-5">
       <div class="card w-full max-w-[350px] space-y-4 text-[15px]">
         <div class="image-container w-full h-[240px]">
           <img src="./images/programs/ent.jpg" alt="" class="w-full h-full object-cover" />
         </div>
         <div class="cardContent space-y-3">
           <h4 class="font-bold">MarketTall women have longer life span compared to short women</h4>
           <p class="opacity-50 text-[13px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum tempore, numquam unde natus quidem tenetur aliquam cum dolore ex iste.</p>
 ...
 <div id="sports" class="content container">
   <div class="flex flex-wrap justify-between gap-auto items-center  md:items-start">
     ...
     <div class="col-lg-3 m-5 p-5">
       <div class="card w-full max-w-[350px] space-y-4 text-[15px]">
         <div class="image-container w-full h-[240px]">
           <img src="./images/programs/001.jpg" alt="" class="w-full h-full object-cover" />
         </div>
         <div class="cardContent space-y-3">
           <h4 class="font-bold">Marketing</h4>
           <p class="opacity-50 text-[13px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum tempore, numquam unde natus quidem tenetur aliquam cum dolore ex iste.</p>
     ...
     <div class="col-lg-3 m-5 p-5">
       <div class="card w-full max-w-[350px] space-y-4 text-[15px]">
         <div class="image-container w-full h-[240px]">
           <img src="./images/programs/giannis.jpg" alt="" class="w-full h-full object-cover" />
         </div>
         <div class="cardContent space-y-3">
           <h4 class="font-bold">MarketTall women have longer life span compared to short women</h4>
           <p class="opacity-50 text-[13px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum tempore, numquam unde natus quidem tenetur aliquam cum dolore ex iste.</p>
     ...
     <div class="col-lg-3 m-5 p-5">
       <div class="card w-full max-w-[350px] space-y-4 text-[15px]">
         <div class="image-container w-full h-[240px]">
           <img src="./images/programs/002.jpg" alt="" class="w-full h-full object-cover" />
         </div>
         <div class="cardContent space-y-3">
           <h4 class="font-bold">technology</h4>
           <p class="opacity-50 text-[13px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum tempore, numquam unde natus quidem tenetur aliquam cum dolore ex iste.</p>
