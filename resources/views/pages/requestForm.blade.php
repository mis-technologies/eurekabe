...
@section('content')
<section
class="flex flex-col md:flex-row-reverse gap-10 h-full w-full items-center justify-center bg-transparent"
>
<div
  id="image-container"
  class="hidden w-full md:w-1/2 md:flex items-center justify-center relative z-10"
>
  <img
    id="register-image"
    src="{{ asset('asset/images/team.png')}}"
    alt="Register"
    class="max-h-full w-full object-cover -z-10"
  />
  <div
  ...
  >
    <h1 class="text-[20px] font-bold">Already signed up?</h1>
...
<div
id="form-container"
class="w-full h-full md:w-1/2 flex flex-col p-8 lg:px-12 rounded-lg pt-28 pb-0"
>
<div
class="h-fit overflow-y-scroll hide-scrollbar flex flex-col justify-start px-1"
>
<!-- form one -->
<form id="signUpForm" class="form mb-5">
  <h3
  class="text-xl lg:text-3xl font-bold mb-10 tracking-wider lg:text-start text-flip-container"
>
  ...
  <div class="mb-4">
    <label class="block text-black font-semibold dark:text-white"
      >Full Name</label
    >
    <input
  ...
  <div class="mb-4">
    ...
    >
      ...
      <option value="Minna" class="">Minna</option>
      <option value="ABU" class="">ABU Zaria</option>
      <option value="University of Lagos" class="">University of Lagos</option>
      <option value="University of Benin" class="">University of Benin</option>
      <option value="University of Jos" class="">University of Jos</option>
      <option value="Covenant University" class="">Covenant University</option>
...
<form id="second-form" class="form hidden">
  <h3
  class="text-xl lg:text-3xl font-bold mb-10 tracking-wider lg:text-start text-flip-container2"
>
  Join the community and <br />become
  ...
  <div class="mb-4">
    <label class="block text-black font-semibold dark:text-white"
      >Do you have a leadership experience in the institution?</label
    >
    <input
      id="leadership-experience"
      type="text"
  ...
  <div class="mb-4">
    <label class="block text-black font-semibold dark:text-white"
      >If yes, which position was that?</label
    >
    <input
      id="leadership-position"
      type="text"
      required
      placeholder="Yes"
      class="mt-2 p-2 px-5 border rounded-full w-full bg-transparent"
  ...
  <div class="mb-4">
    <label class="block text-black font-semibold dark:text-white"
      >Give us your three attributes of a leader you find dear.</label
    >
    <input
      id="leader-attributes"
      type="text"
      required
      placeholder="Money minded, Disciplined, Smart."
      class="mt-2 p-2 px-5 border rounded-full w-full bg-transparent"
    />
  </div>
  <div class="mb-4">
    <label class="block text-black font-semibold dark:text-white"
      >Tell us how you know about Eureka.</label
    >
    <select
      id="how-know-eureka"
      required
  ...
  <div class="submit_success container bg-white rounded-xl w-full h-fit max-w-[580px] items-center justify-center translate-y-5 py-12 dark:bg-dark relative" id="submit_success">
    ...
    <div class="flex-col flex items-center justify-center gap-10 h-full w-full">
      ...
      <div class="flex flex-col items-center w-full text-primary gap-3 dark:text-white">
        ...
        <button class="mt-4 bg-blue-500 text-white px-4 py-2 rounded" id="redirect_home">Go to Home</button>
      </div>
    </div>
  </div>
</div>
