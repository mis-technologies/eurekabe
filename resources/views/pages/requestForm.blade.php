...
>
  <div
    class="h-fit overflow-y-scroll hide-scrollbar flex flex-col justify-start"
  >
    <!-- form one -->
    <form id="signUpForm" class="form mb-5">
      <h3
        class="text-xl lg:text-3xl font-bold mb-6 tracking-wider lg:text-start text-flip-container"
      >
...
<!-- Popup  -->
<div
  class="submit_success container bg-white rounded-xl w-full h-fit max-w-[580px] items-center justify-center translate-y-5 py-12 dark:bg-dark"
  id="submit_success"
>
  <div
  ...
  >
    ...
    <div
      class="flex flex-col items-center w-full text-primary gap-3 dark:text-white"
    >
      <h1 class="font-bold text-center text-3xl pb-2">
