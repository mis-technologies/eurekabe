                    ...
                    <div class="card p-6">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="">
                                ...
                                <input required type="text" id="title" name="duration" class="form-input"
                                    placeholder="e.g 20" aria-describedby="input-helper-text">
                            </div>

                            <div class="">
                                <label for="project-name" class="mb-2 block">Pass Percentage</label>
                                <input required type="text" id="title" name="pass_percentage" class="form-input"
                            ...
                            {{-- <div>
                                    ...
                                    <input type="text" id="budget" class="form-input" placeholder="Enter Project Budget">
                                </div> --}}
                        </div>
                    </div>
                </div>
