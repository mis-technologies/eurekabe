...
<body class="transition-all duration-1000 dark:bg-dark">
        ...
        <nav class="flex justify-between items-center py-5 container">
            ...
            <label
                ...
                <div class="relative">
                    ...
                    <!-- Switch Background -->
                    <div class="block bg-black w-[70px] h-9 rounded-full dark:bg-blue-200 transition-all duration-700">
                    </div>
                    <div class="block bg-black w-[70px] h-9 rounded-full dark:hidden absolute top-0 left-0">
                        <div class="w-full h-full rounded-full relative">
                            ...
                            <div class="bg-white absolute bottom-[80%] right-[45%] w-[1.5px] h-[1.5px] rounded-full">
                            </div>
                ...
                <div class="switchIcon absolute right-1 top-1 rounded-full transition-all ease-in-out h-7 w-7">
                    <div id="lightIcon" class="relative">
                        ...
                        <img src="{{ asset('asset/images/icons/clouds.png')}}" alt=""
            ...
            <!-- Mobile Nav Bar -->
            <div class="container absolute top-24 left-0 w-full py-10 hidden flex-col items-start justify-center gap-6 rounded-lg bg-secondary dark:bg-dark md:hidden"
                id="mobileNav">
            ...
            <div class="container w-full flex flex-col items-center mx-auto md:max-w-2xl gap-7 text-center z-[3]">
                ...
                <div
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <img src="{{ asset('asset/images/designs/Vector 7.png')}}" alt="" class="w-1/3 h-auto mt-2" />
                    </div>
                </div>
            </div>
            <!-- Footer Icons -->
    ...
    <div id="communityFooterr" class="container flex flex-col items-center justify-between py-7 md:flex-row gap-y-10 dark:text-white">
        ...
        <div class="flex items-center gap-6">
            ...
            <a href="https://x.com" target="_blank"><i class="fab fa-x-twitter font-bold text-3xl"></i></a>
