...
<head>
    ...
    <link  href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap"
        rel="stylesheet" />
    ...
    <script defer src="asset/src/scripts/main.js"></script>
...
<body class="transition-all duration-150 dark:bg-dark">

    <header class="sticky top-0 left-0 z-50 bg-secondary dark:bg-dark">
        <nav class="flex justify-between items-center py-5 container">
          <a class="translate-y-1" href="/">
            <img src="{{asset('asset/images/logo.png')}}" alt="Eureka" />
</a>
          ...
          <!-- Nav Items -->
           ...
           <!-- Toggle Switch -->
           <label class="flex items-center cursor-pointer absolute right-[20%] md:right-[25%] xl:right-[30%]">
            <div class="relative">
                <input id="theme-toggle" type="checkbox" class="sr-only" />
                <!-- Switch Background -->
                <div class="block bg-black w-[70px] h-9 rounded-full dark:bg-blue-200 transition-all duration-150"></div>
                <!-- Switch Icon -->
                <div class="switchIcon absolute right-1 top-1 rounded-full transition-transform h-7 w-7">
                  <div id="lightIcon" class="relative">
                    <img src="asset/images/icons/Toggle.png" alt="">
                    <img src="asset/images/icons/clouds.png" alt="" class="absolute scale-75 -right-2 top-1/2 -translate-y-1/2">
                  </div>
                  <div id="darkIcon" class="bg-white w-full h-full rounded-full hidden">
                    <div class="bg-dark w-full h-full rounded-full -translate-x-2">
                    </div>
                  </div>
                </div>
            </div>
    ...
    <footer class="bg-secondary relative dark:bg-dark dark:text-white" >
      ...
      <!-- Footer Socials -->
       <div class="container flex flex-col items-center justify-between py-7 md:flex-row gap-y-10 dark:text-white">
        <img src="asset/images/logo.png" alt="" class="eurekaLogo md:-translate-x-5 eurekaLogo">
