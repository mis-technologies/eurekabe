...
<section id="faq" class="container py-10">
    ...
    >
      ...
      >
        <img src="/images/programs/5225086 1.png" alt="" />
        ...
        <form id="faq" class="w-full flex flex-col gap-5 items-center">
          ...
          <div class="w-full flex flex-col gap-1">
            ...
            <textarea
              ...
              class="w-full p-4 px-6 rounded-3xl border-[#ddd] border-2 focus:outline-none dark:bg-dark"
              required
            ></textarea>
          </div>
          <div class="form-group">
            <button
              type="submit"
              class="bg-primary w-48 py-3 font-bold text-white text-lg rounded-full cursor-pointer hover:opacity-80 hover:scale-105"
            >
              Send
            </button>
          </div>
