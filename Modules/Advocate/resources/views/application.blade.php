...
<div id="verify-route" data-register-route="{{ route('advocate.verify.email') }}" ></div>
<div id="register-route" data-register-route="{{ route('advocate.apply.send') }}" ></div>
